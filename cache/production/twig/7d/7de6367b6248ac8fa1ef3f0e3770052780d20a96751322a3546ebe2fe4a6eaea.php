...
/* attachment.html */
class __TwigTemplate_a4691c5e32c7000a3ecf930de77facaa3d65f8e4713bb5f77c435577ef826276 extends Twig_Template
{
...
\t\t\t";
                    ...
                    if ($this->getAttribute($context["_file"], "S_QUICKTIME_FILE", array())) {
                        ...
                        echo $this->getAttribute($context["_file"], "ATTACH_ID", array());
                        echo "); return false;\">[ ";
                        echo $this->env->getExtension('phpbb\template\twig\extension')->lang("PLAY_QUICKTIME_FILE");
                        echo " ]</a> ";
                    }
                    // line 117
                    echo "\t\t\t<a href=\"";
