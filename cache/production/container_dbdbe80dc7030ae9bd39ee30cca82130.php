...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005f836f670000000029ddbc9b(
...
class phpbbtemplatetwiglexer_000000005f836f670000000029ddbc9b extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59867e28ed2d0936058874 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59867e28ed2d0690731316 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59867e28ed2d0652404000 = array(
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, 'set_environment', array('env' => $env), $this->initializer59867e28ed2d0690731316);

        return $this->valueHolder59867e28ed2d0936058874->set_environment($env);
    }
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59867e28ed2d0690731316);

        return $this->valueHolder59867e28ed2d0936058874->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59867e28ed2d0690731316);

        return $this->valueHolder59867e28ed2d0936058874->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59867e28ed2d0690731316 = $initializer;
    }
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__get', array('name' => $name), $this->initializer59867e28ed2d0690731316);

        if (isset(self::$publicProperties59867e28ed2d0652404000[$name])) {
            return $this->valueHolder59867e28ed2d0936058874->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59867e28ed2d0936058874;
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59867e28ed2d0690731316);
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__isset', array('name' => $name), $this->initializer59867e28ed2d0690731316);
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__unset', array('name' => $name), $this->initializer59867e28ed2d0690731316);
    ...
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__clone', array(), $this->initializer59867e28ed2d0690731316);

        $this->valueHolder59867e28ed2d0936058874 = clone $this->valueHolder59867e28ed2d0936058874;
    }

    public function __sleep()
    {
        $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, '__sleep', array(), $this->initializer59867e28ed2d0690731316);

        return array('valueHolder59867e28ed2d0936058874');
    }
    ...
    {
        return $this->initializer59867e28ed2d0690731316;
    }
    ...
    {
        return $this->initializer59867e28ed2d0690731316 && $this->initializer59867e28ed2d0690731316->__invoke($this->valueHolder59867e28ed2d0936058874, $this, 'initializeProxy', array(), $this->initializer59867e28ed2d0690731316);
    }
    ...
    {
        return null !== $this->valueHolder59867e28ed2d0936058874;
    }
    ...
    {
        return $this->valueHolder59867e28ed2d0936058874;
    }
